...
def LoadCargoes(ID_Reduced, ContainerData, CalledFrom):    
        ...
        if time_Elapsed <= 300:
            ...
            while IsCargoPlaced == 1:
                ...
                while i <len(CargoRem):
                                        ...
                                        if WtDistMetFlag == 1:
                                            ...
                                            if WtLimitExceedFlag == 0:
                                                ...
                                                if SuffSupportAreaFlag == 1:
                                                    ...
                                                    IsCargoPlaced = 1
                                                    SkipRemainingCoordinates = 1 # Skip further explorations of coordinates
                                                    ...
                                                    CargoLoaded_Or.append(CargoP[i][p])   
                    ...
                    if IsCargoPlaced == 1:
                        i = TotalRecords + 1
                        # print('cargo '+str(cargo)+' placed')
                    else:
                        # print('cargo '+str(cargo)+' not placed')
                        i = i + 1
            ...
            dfOT["HeurOption"].fillna("LHB", inplace = True) 
            ...
            FinalSol_Temp = pd.merge(FinalSol_Temp, ID_Reduced[['Sno','OrderNbr','Volume', 'Margin']], on=['Sno'], how='left')        
            FinalSol_Temp["CDOption"].fillna(CDOption, inplace = True) 
            FinalSol_Temp["HeurOption"].fillna("LHB", inplace = True) 
    ...
    #FinalSol.to_csv('FinalSol.csv', sep=',', encoding='utf-8', index = False)
    #print(FinalSol)
    #Summary_FinalSol.to_csv('Summary_FinalSol_LBB.csv', sep=',', encoding='utf-8', index = False)
    return FinalSol, Summary_FinalSol, ConstHeurSolFeasibile, dfOT_Final
